                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                 ...
                 <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home-tab-pane"name="category_id" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                        <div class="mb-3">
                            <label class="mb-3"> Book Category</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Enter Slug" />
                            @error('name')
                                <strong class="text-danger">{{$message}}</strong>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="small_description" class="form-control" rows="6" placeholder="Enter Description"></textarea>
                    ...
                    <div class="tab-pane fade" id="seo-tab-pane" role="tabpanel" aria-labelledby="seo-tab" tabindex="0">
                        <div class="mb-3">
                            ...
                            <input type="text" name="meta_title" class="form-control" placeholder="Enter Slug" />
                            @error('meta_title')
                                <strong class="text-danger">{{$message}}</strong>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="meta_description" class="form-control" rows="6" placeholder="Enter Description"></textarea>
                            @error('description')
                                <strong class="text-danger">{{ $message }}</strong>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea name="meta_keyword" class="form-control" rows="6" placeholder="Enter Description"></textarea>
                            @error('meta_keyword')
                                <strong class="text-danger">{{ $message }}</strong>
                            @enderror
                        </div>
                    ...
                    <div class="tab-pane fade" id="details-tab-pane" role="tabpanel" aria-labelledby="details-tab" tabindex="0">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="original_price" class="form-control" placeholder="Enter Slug" />
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="selling_price" class="form-control" placeholder="Enter Slug" />
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="quantity" class="form-control" placeholder="Enter Slug" />
